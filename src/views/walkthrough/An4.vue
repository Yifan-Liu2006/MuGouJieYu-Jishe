  ...
  <div class="walkthrough-page">
    ...
    <div class="breadcrumb-wrapper">
      <el-breadcrumb separator="/" class="chinese-breadcrumb">
        ...
        <el-breadcrumb-item>
          <i class="iconfont icon-ceng" style="margin-right: 4px"></i>暗四层
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div class="page-header">
      ...
      <p class="page-subtitle">沉浸式体验应县木塔暗四层的内部结构与装饰</p>
    </div>
    ...
    <div class="controls-container">
      <div class="control-group">
        ...
        <div class="button-row">
          <el-button @click="navigateTo('/walkthrough/ming5')" class="control-button">
      ...
      <div class="control-group">
        ...
        <div class="科普-content">
          <p>应县木塔暗四层是木塔的内部结构层，位于明四层和明五层之间。暗层是木塔的重要组成部分，虽然从外部看不到，但对木塔的结构稳定性起着关键作用。</p>
          <p>暗四层的主要功能是加强木塔的结构强度，通过复杂的梁枋、斜撑和斗拱系统，将上层的重量均匀传递到下层。这里的结构设计展现了中国古代建筑师的智慧。</p>
          <p>暗四层的空间相对较小，主要用于结构支撑，不对外开放。但通过第一视角漫游，我们可以近距离观察这些木塔内部精美的佛像。</p>
          <p>暗层的存在是应县木塔能够抵御多次地震的重要原因之一，它们如同木塔的"骨架"，提供了强大的支撑和抗震能力。</p>
        </div>
      </div>
    </div>
    ...
    >
      <div class="error-content">
        <p>无法加载模型文件 An4.glb，请检查文件是否存在。</p>
